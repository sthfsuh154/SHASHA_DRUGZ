...
@app.on_message(filters.command(["sha","shan", "shasha"], prefixes=["sha", "Sha", "/"]) & admin_filter)
...
__mod_name__ = "H_B_36"
__help__ = """
🔻 /shashaban <reply to user> ban ➠ ʙᴀɴ ᴀ ᴜsᴇʀ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  
🔻 /shashaunban <reply to user> unban ➠ ᴜɴʙᴀɴ ᴀ ᴜsᴇʀ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  
🔻 /shashakick <reply to user> kick ➠ ᴋɪᴄᴋ ᴀ ᴜsᴇʀ ᴏᴜᴛ ᴏғ ᴛʜᴇ ɢʀᴏᴜᴘ  
🔻 /shashamute <reply to user> mute ➠ ᴍᴜᴛᴇ ᴀ ᴜsᴇʀ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  
🔻 /shashaunmute <reply to user> unmute ➠ ᴜɴᴍᴜᴛᴇ ᴀ ᴜsᴇʀ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  
🔻 /shashapromote <reply to user> promote ➠ ᴘʀᴏᴍᴏᴛᴇ ᴀ ᴜsᴇʀ ᴛᴏ ᴀᴅᴍɪɴ  
🔻 /shashademote <reply to user> demote ➠ ᴅᴇᴍᴏᴛᴇ ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴀᴅᴍɪɴ
"""
