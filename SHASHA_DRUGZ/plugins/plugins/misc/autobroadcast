...
# ------------------ Command handlers ------------------
@app.on_message(filters.command("abroadcastimage") & filters.private)
...
@app.on_message(filters.command("abroadcastmsg") & filters.private)
...
@app.on_message(filters.command("abroadcasturl") & filters.private)
...
@app.on_message(filters.command("resetautobroadcast") & filters.private)
...
@app.on_message(filters.command("autobroadcast") & filters.private)
...
@app.on_callback_query(filters.regex("^ab_(enable|disable)$"))
