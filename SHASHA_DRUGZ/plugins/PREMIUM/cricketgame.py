...
@app.on_callback_query(filters.regex(r"^cricket_"))
...
@app.on_message(filters.command("solocricket") & filters.group)
...
@app.on_message(filters.command("joincricket") & filters.group)
...
@app.on_message(filters.command("startsolocricket") & filters.group)
...
@app.on_message(filters.command("setovers") & filters.group)
...
@app.on_message(filters.command("setspamfree") & filters.group)
...
@app.on_message(filters.command("extendsolocricket") & filters.group)
...
@app.on_message(filters.command("cricketsolo_status") & filters.group)
...
@app.on_message(filters.command("cricketsoloscore") & filters.group)
...
@app.on_message(filters.command("cricketsoloplayers") & filters.group)
...
@app.on_message(filters.command("cricketsololeave") & filters.group)
...
@app.on_message(filters.command("cricketmystatus") & (filters.group | filters.private))
...
@app.on_message(filters.command("cricketendsolo") & filters.group)
...
@app.on_message(filters.command("cricketuserinfo") & (filters.group | filters.private))
...
@app.on_message(filters.command("cricketleaderboard") & (filters.group | filters.private))
...
@app.on_callback_query(filters.regex(r"^lb_"))
...
@app.on_message(filters.command("cricketcoins") & (filters.group | filters.private))
...
@app.on_message(filters.command("cricketbadges") & (filters.group | filters.private))
...
@app.on_message(filters.command("cricketmissions") & (filters.group | filters.private))
...
@app.on_message(filters.command("cricketgame") & filters.group)
...
@app.on_callback_query(filters.regex(r"^teamhost_"))
...
@app.on_callback_query(filters.regex(r"^tmode_"))
...
@app.on_message(filters.command("cricketcreateteam") & filters.group)
...
@app.on_message(filters.command("cricketjoinAteam") & filters.group)
...
@app.on_message(filters.command("cricketjoinBteam") & filters.group)
...
@app.on_message(filters.command("addcricket") & filters.group)
...
@app.on_message(filters.command("removecricketplayer") & filters.group)
...
@app.on_message(filters.command("cricketteams") & filters.group)
...
@app.on_message(filters.command("cricketstartteam") & filters.group)
...
@app.on_message(filters.command("cricketscore") & filters.group)
...
@app.on_message(filters.command(["batting", "bowling"]) & filters.group)
...
@app.on_message(filters.command("crickettournament") & filters.group)
...
@app.on_message(filters.command("joincrickettourn") & filters.group)
...
@app.on_message(filters.command("settournamentovers") & filters.group)
...
@app.on_message(filters.command("startcrickettournament") & filters.group)
...
@app.on_message(filters.command("tournamentstatus") & filters.group)
...
@app.on_message(filters.command("endcrickettourn") & filters.group)
...
@app.on_message(filters.command("crickethelp") & (filters.group | filters.private))
