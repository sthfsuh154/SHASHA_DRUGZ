...
@app.on_message(filters.command("rrshowroles"))
...
@app.on_message(filters.command("rajaranirules"))
...
# --- SHOP LOGIC ---
@app.on_message(filters.command("rrshop"))
...
@app.on_message(filters.command(["rrprofile", "rrrank"]))
@app.on_callback_query(filters.regex("my_profile"))
...
# ================= 🎮 LOBBY SYSTEM ================= #
@app.on_message(filters.command("rajarani") & filters.group)
...
@app.on_message(filters.command("rrjoin") & filters.group)
@app.on_callback_query(filters.regex("rr_join"))
...
@app.on_callback_query(filters.regex("rr_start"))
...
@app.on_message(filters.command("rrend") & filters.group)
...
@app.on_callback_query(filters.regex("end_game_btn"))
...
@app.on_callback_query(filters.regex("night_menu"))
...
@app.on_callback_query(filters.regex("rr_check"))
...
@app.on_callback_query(filters.regex(r"guess_(\d+)"))
...
# ================= 🏆 LEADERBOARDS ================= #
@app.on_message(filters.command("rrtop"))
...
@app.on_callback_query(filters.regex("top_global"))
