...
@app.on_message(filters.command("chesstop"))
...
@app.on_message(filters.command("chessgame") & filters.group)
...
@app.on_message(filters.command("chessplaying") & filters.group)
...
# ================= CALLBACKS =================
@app.on_callback_query(filters.regex(r"^(s:|join:|color:|rot:|draw:|resign:|rematch:|lb:)"))
