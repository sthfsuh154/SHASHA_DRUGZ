...
from SHASHA_DRUGZ.utils.decorators.admins import ActualAdminCB
from SHASHA_DRUGZ.utils.decorators.language import language, languageCB
from SHASHA_DRUGZ.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from SHASHA_DRUGZ.utils.inline.dstart import dprivate_panel
from config import BANNED_USERS, OWNER_ID


@Client.on_message(
    filters.command(["setting", "settings"]) & filters.group & ~BANNED_USERS
)
@language
...
__mod_name__ = "H_B_47"
__help__ = """
🔻 /setting or /settings ➠ ᴏᴘᴇɴ ᴛʜᴇ ɢʀᴏᴜᴘ sᴇᴛᴛɪɴɢs ᴍᴇɴᴜ ᴡɪᴛʜ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs
🔻 Buttons in the menu allow:
   • ᴄʜᴀɴɢɪɴɢ ᴘʟᴀʏ ᴍᴏᴅᴇ (Direct / Inline)
   • ᴄʜᴀɴɢɪɴɢ ᴘʟᴀʏ ᴛʏᴘᴇ (Everyone / Admin)
   • ᴍᴀɴᴀɢɪɴɢ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀs
   • ᴇɴᴀʙʟɪɴɢ / ᴅɪsᴀʙʟɪɴɢ ᴠᴏᴛᴇ ᴍᴏᴅᴇ
"""
MOD_TYPE = "MUSIC"
MOD_NAME = "Music-Config"
MOD_PRICE = "50"
