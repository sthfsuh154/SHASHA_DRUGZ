...
@Client.on_message(filters.command(["block"]) & SUDOERS)
@language
...
@Client.on_message(filters.command(["unblock"]) & SUDOERS)
@language
...
@Client.on_message(filters.command(["blocked", "blockedusers", "blusers"]) & SUDOERS)
@language
