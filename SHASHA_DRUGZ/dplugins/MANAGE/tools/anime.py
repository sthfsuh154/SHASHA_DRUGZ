...
DOWN_PATH = "SHASHA_DRUGZ/downloads/"
...
@Client.on_message(filters.command(["top", f"top{BOT_USERNAME}"], prefixes=PREFIX_HANDLER))
@control_user
...
@Client.on_callback_query(filters.regex(pattern=r"anpin_(.*)"))
...
async def anime_edit_cmd(client: Client, message: Message):
...
async def manga_edit_cmd(client: Client, message: Message):
...
async def character_edit_cmd(client: Client, message: Message):
...
async def anilist_edit_cmd(client: Client, message: Message):
...
async def top_edit_cmd(client: Client, message: Message):
...
async def airing_edit_cmd(client: Client, message: Message):
...
async def settings_edit_cmd(client: Client, message: Message):
...
async def browse_edit_cmd(client: Client, message: Message):
...
async def tags_genres_edit_cmd(client: Client, message: Message):
...
@check_user
async def wls(client: Client, cq: CallbackQuery, cdata: dict):
...
@Client.on_callback_query(filters.regex("changek_quote"))
...
__mod_name__ = "H_B_64"
__help__ = """
🔻 /anime <name or ID> ➠ sᴇᴀʀᴄʜ ғᴏʀ ᴀɴ ᴀɴɪᴍᴇ ᴀɴᴅ ɢᴇᴛ ᴅᴇᴛᴀɪʟᴇᴅ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  
🔻 /manga <name or ID> ➠ sᴇᴀʀᴄʜ ғᴏʀ ᴀ ᴍᴀɴɢᴀ ᴀɴᴅ ɢᴇᴛ ᴅᴇᴛᴀɪʟᴇᴅ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  
🔻 /character <name> ➠ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀɴ ᴀɴɪᴍᴇ ᴄʜᴀʀᴀᴄᴛᴇʀ.  
🔻 /anilist <name> ➠ sᴇᴀʀᴄʜ ғᴏʀ ᴀɴ ᴀɴɪᴍᴇ ᴜsɪɴɢ ᴀɴɪʟɪsᴛ (sɪᴍɪʟᴀʀ ᴛᴏ /anime).  
🔻 /top [genre/tag] ➠ ɢᴇᴛ ᴛᴏᴘ ᴀɴɪᴍᴇs ʙʏ ɢᴇɴʀᴇ ᴏʀ ᴛᴀɢ. ɪғ ɴᴏ ᴀʀɢᴜᴍᴇɴᴛ, sʜᴏᴡs ᴏᴠᴇʀᴀʟʟ ᴛᴏᴘ.  
🔻 /studio <name> ➠ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀɴ ᴀɴɪᴍᴇ sᴛᴜᴅɪᴏ.  
🔻 /airing <name> ➠ ɢᴇᴛ ᴀɪʀɪɴɢ ᴅᴇᴛᴀɪʟs ᴏғ ᴀɴ ᴀɴɪᴍᴇ.  
🔻 /anisettings ➠ ᴄʜᴀɴɢᴇ ᴀɴɪᴍᴇ-ʀᴇʟᴀᴛᴇᴅ sᴇᴛᴛɪɴɢs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ (ᴀᴅᴍɪɴ ᴏɴʟʏ).  
🔻 /browse ➠ ʙʀᴏᴡsᴇ ᴛʀᴇɴᴅɪɴɢ, ᴘᴏᴘᴜʟᴀʀ, ᴏʀ ᴜᴘᴄᴏᴍɪɴɢ ᴀɴɪᴍᴇ.  
🔻 /gettags [nsfw] ➠ ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ᴀɴɪᴍᴇ ᴛᴀɢs. ᴀᴅᴅ "nsfw" ᴛᴏ ɪɴᴄʟᴜᴅᴇ ᴀᴅᴜʟᴛ ᴛᴀɢs.  
🔻 /getgenres ➠ ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ᴀɴɪᴍᴇ ɢᴇɴʀᴇs.  
🔻 /schedule ➠ ɢᴇᴛ ᴛʜᴇ sᴄʜᴇᴅᴜʟᴇ ᴏғ ᴄᴜʀʀᴇɴᴛʟʏ ᴀɪʀɪɴɢ ᴀɴɪᴍᴇ.  
🔻 /watch <anime name> ➠ ɢᴇᴛ ᴛʜᴇ ᴡᴀᴛᴄʜ ᴏʀᴅᴇʀ ғᴏʀ ᴀ ғʀᴀɴᴄʜɪsᴇ (ᴇ.ɢ., ʜᴇ Fᴀᴛᴇ, Mᴏɴᴏɢᴀᴛᴀʀɪ).  
🔻 /fillers <anime name> ➠ ɢᴇᴛ ғɪʟʟᴇʀ ᴇᴘɪsᴏᴅᴇs ғᴏʀ ᴀɴ ᴀɴɪᴍᴇ.  
🔻 /animequotes ➠ ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ᴀɴɪᴍᴇ qᴜᴏᴛᴇ ɪᴍᴀɢᴇ.
"""
