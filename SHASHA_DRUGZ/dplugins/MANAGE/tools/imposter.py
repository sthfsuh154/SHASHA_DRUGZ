...
from pyrogram.errors import ChatSendPhotosForbidden, ChatWriteForbidden, ChatSendMediaForbidden
...
""".format(bef=lastname_before, aft=lastname_after)
    ...
    if msg != "":
        ...
        except (ChatSendPhotosForbidden, ChatSendMediaForbidden):
            # Chat doesn't allow photos/media — fall back to plain text
            await message.reply(msg)
        except ChatWriteForbidden:
            # Bot is muted entirely, nothing we can do
            pass
