...
@Client.on_message(filters.command("setnsfwapi") & filters.group)
...
# ══════════════════════════════════════════════════════════════════════════════
@Client.on_callback_query(filters.regex(r"^(nsfw_|toggle_|scan_types|nsfw_api_info|change_warning_image)"))
...
@Client.on_message(filters.group & filters.create(_not_command), group=2)
